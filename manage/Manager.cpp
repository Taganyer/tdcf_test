...
void Manager::root() {
    ...
    DEBUG("%s ROOT[%u] start", __PRETTY_FUNCTION__, _id->guid());
    ...
    DEBUG("%s ROOT[%u] start end_cluster: %s", __PRETTY_FUNCTION__, _id->guid(), tdcf::status_flag_name(flag));
    flag = root->end_cluster();
    DEBUG("%s ROOT[%u] end: %s", __PRETTY_FUNCTION__, _id->guid(), tdcf::status_flag_name(flag));
}
...
void Manager::node_root() {
    ...
    DEBUG("%s NODE_ROOT[%u] start", __PRETTY_FUNCTION__, _id->guid());
    ...
    DEBUG("%s NODE_ROOT[%u] start end_cluster: %s", __PRETTY_FUNCTION__, _id->guid(), tdcf::status_flag_name(flag));
    flag = node_root->end_cluster();
    DEBUG("%s NODE_ROOT[%u] end: %s", __PRETTY_FUNCTION__, _id->guid(), tdcf::status_flag_name(flag));
}

void Manager::pure_node() {
    auto node = create_node();
    node.start_node();
    DEBUG("%s NODE[%u] start", __PRETTY_FUNCTION__, _id->guid());
    ...
    DEBUG("%s NODE[%u] end: %s", __PRETTY_FUNCTION__, _id->guid(), tdcf::status_flag_name(flag));
}
